...
public class DodgeAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        for (int i = 0; i < raycount; i++)
        {
            ...
            //         var vel = new Vector2(rig.linearVelocity.x, rig.linearVelocity.z);
            ...
            if(Physics.Raycast(ray, out hit, ray_length)){
                ...
                if(hit.collider.gameObject.name == "ArenaWalls"){
                    ...
                    Rigidbody rig = hit.collider.gameObject.GetComponent<Rigidbody>();
                    sensorDistList.Add(rig.linearVelocity.x);
                    sensorDistList.Add(rig.linearVelocity.z);
                }
        ...
        sensor.AddObservation(RbAgent.linearVelocity.x);
        sensor.AddObservation(RbAgent.linearVelocity.z);
