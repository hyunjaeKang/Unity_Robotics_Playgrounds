...
public class DroneAgent: Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(agent_Rigidbody.linearVelocity);
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        dcoScript.DriveInput(moveX);  // forward and backword
        dcoScript.StrafeInput(moveY); // right and left
        dcoScript.LiftInput(moveZ);   // Up and down
